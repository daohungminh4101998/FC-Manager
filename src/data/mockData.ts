...
export const mockPerformances: MatchPerformance[] = [
  {
    ...
    savedAt: dayjs().subtract(28, 'day').toISOString(),
    performances: [
      { playerId: 'p8', goals: 2, assists: 0 },
      { playerId: 'p9', goals: 1, assists: 1 },
      { playerId: 'p6', goals: 0, assists: 2 },
      { playerId: 'p5', goals: 0, assists: 1 },
    ],
  },
  {
    matchId: 'm2',
    savedAt: dayjs().subtract(21, 'day').toISOString(),
    performances: [
      { playerId: 'p9', goals: 2, assists: 0 },
      { playerId: 'p10', goals: 1, assists: 1 },
      { playerId: 'p8', goals: 1, assists: 0 },
      { playerId: 'p6', goals: 0, assists: 1 },
    ],
  },
  {
    matchId: 'm3',
    savedAt: dayjs().subtract(14, 'day').toISOString(),
    performances: [
      { playerId: 'p8', goals: 1, assists: 1 },
      { playerId: 'p5', goals: 1, assists: 0 },
      { playerId: 'p7', goals: 0, assists: 2 },
    ],
  },
  {
    matchId: 'm4',
    savedAt: dayjs().subtract(7, 'day').toISOString(),
    performances: [
      { playerId: 'p9', goals: 3, assists: 0 },
      { playerId: 'p6', goals: 1, assists: 1 },
      { playerId: 'p8', goals: 0, assists: 2 },
      { playerId: 'p12', goals: 1, assists: 0 },
    ],
  },
];
